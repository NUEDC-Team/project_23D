...
HD_PWD='D:/Coding/Vivado/project/project_23H/project_2PSK_3/project_2PSK_3.runs/fir_compiler_high_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_compiler_high.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_compiler_high.tcl
